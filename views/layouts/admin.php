...
<head>
    ...
    <script src="<?=Url::to('/static/admin/js/Calendar.js');?>"></script>
    ...
    <div class="leftpanel">
        ...
        <div class="leftpanelinner">
            ...
            <ul class="nav nav-pills nav-stacked nav-bracket" id="sidemenus">
                ...
                <li class="nav-parent"><a href=""><i class="fa fa-edit"></i> <span>提交用户</span></a>
                    <ul class="children">
                        <li><a href="<?=Url::to(['/admin/user/index']);?>"><i class="fa fa-caret-right"></i> 用户列表</a></li>
                    </ul>
                </li>
